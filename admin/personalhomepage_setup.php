...
/**
 * 	\file		admin/personalhomepage.php
...
require_once '../lib/personalhomepage.lib.php';
 ...
 * View
 */
$page_name = "PersonalHomePageSetup";
...
$head = personalhomepageAdminPrepareHead();
dol_fiche_head(
    $head,
    'settings',
    $langs->trans("Module104969Name"),
    0,

...
/**
 * 	\file		core/triggers/interface_99_modMyodule_PersonalHomePagetrigger.class.php
 * 	\ingroup	personalhomepage
 * 	\brief		Sample trigger
 * 	\remarks	You can create other triggers by copying this one
 * 				- File name should be either:
 * 					interface_99_modPersonalhomepage_Mytrigger.class.php
 ...
 * Trigger class
 */
class InterfacePersonalHomePagetrigger
{
